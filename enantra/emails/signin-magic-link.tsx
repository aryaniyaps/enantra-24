import { APP_NAME, APP_TAGLINE, FEEDBACK_EMAIL } from "@/utils/constants";
import {
  Body,
  Container,
  Head,
...
export const MagicLinkEmail = ({ verificationUrl }: MagicLinkEmailProps) => (
  <Html>
    <Head />
    <Preview>Login to {APP_NAME} with this magic link</Preview>
    <Body style={styles.main}>
      <Container style={styles.container}>
        ...
        <Heading style={styles.h1}>Sign In to {APP_NAME}</Heading>

        <Text style={styles.subText}>Click the button below to sign in.</Text>
